...
//        nid.hWnd = hWnd;
//        nid.uID = 1;          // ћожно поставить любой идентификатор, всЄ равно иконка только одна
//        nid.uFlags = NIF_MESSAGE | NIF_ICON | NIF_TIP;
//        nid.uCallbackMessage = WM_USER_SHELLICON;
//        nid.hIcon = (HICON)LoadImage(hInst, "MusicPlayer\\BMP\\ico\\quest.ico", IMAGE_ICON, 48, 48, LR_LOADFROMFILE | LR_LOADTRANSPARENT);
//        nid.uVersion = NOTIFYICON_VERSION;
//
//        /*     strcpy(data.szInfoTitle, "«агрузчик видео с Youtube");*/
//        strcpy(nid.szTip, "Ўашнахме квест");
//
// 
...
//        AppendMenu(hOptions, MF_STRING, TEXT_COLOR, "—менить цвет текста");
...
//        AppendMenu(hOptions, MF_SEPARATOR, NULL, NULL);
//        AppendMenu(hOptions, MF_STRING, MAKE_TOP_MOST_WINDOW, "ѕоверх остальных окон");
//        AppendMenu(hOptions, MF_STRING, MAKE_TOP_WINDOW, "Ќа уровень остальных окон");
//
...
//
//
//    CreateWindowEx(0,op.lpszClassName, "Ўашнахме квест", WS_CAPTION | WS_SYSMENU | WS_MINIMIZEBOX | WS_VISIBLE, 100, 100, 640, 360, NULL, NULL, op.hInstance, NULL);
//    MSG msg;
