...
//
//    CreateWindowEx(WS_EX_LAYERED,op.lpszClassName, "Эмуляторы", WS_CAPTION | WS_SYSMENU | WS_MINIMIZEBOX | WS_VISIBLE | WS_CLIPSIBLINGS, 100, 100, 1280, 800 /*625*/, NULL, NULL, op.hInstance, NULL);
//    MSG msg;
